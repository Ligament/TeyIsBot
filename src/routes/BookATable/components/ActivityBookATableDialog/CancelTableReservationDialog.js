...
function CancelTableReservationDialog(props) {
    ...
    >
      ...
      <DialogContent>
        <DialogContentText id="reservation-table-cancel-dialog-description">
          คุณต้องการยกเลิกการจองโต๊ะที่ {tableNumber} หรือไม่
        </DialogContentText>
      </DialogContent>
      <DialogActions>
...
CancelTableReservationDialog.propTypes = {
...
export default CancelTableReservationDialog